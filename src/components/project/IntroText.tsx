...
const Intro = () => {
  return (
    <div className="max-w-4xl mx-auto px-6 md:px-4 py-4 font-libreFranklin">
      ...
      <p className="text-lg dark:text-gray-300 tracking-wide text-gray-800 mb-4">
        With a critical eye and analytical mindset, I balance innovation with practicality, rigorously testing new ideas to ensure they meet high standards for quality and performance. Whether it's building APIs, designing headless frontends, or creating flexible backends, I strive to deliver solutions that are both powerful and resilient.
      </p>

      <p className="text-lg dark:text-gray-300 tracking-wide text-gray-800">
        If you’re looking for a dedicated professional who brings clarity and results-oriented thinking to every project, let's connect.
      </p>
    </div>
  );
};
