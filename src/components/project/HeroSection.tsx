...
export default function HeroSection() {
  ...
  return (
    ...
    >
     <div>
       <div>
        <h2 className="font-libre-franklin relative z-20 text-4xl lg:text-6xl font-bold text-black dark:text-white font-sans tracking-tight leading-tight">
          Hey there!
          <span className="inline-block ml-4 bg-clip-text text-transparent bg-no-repeat bg-gradient-to-r from-purple-500 via-red-500 to-yellow-500 md:py-4">
            I'm Navaneeth Vijay
          </span>
        </h2>

        <h2 className="font-libre-franklin text-xl lg:text-5xl  relative mx-auto inline-block text-center [filter:drop-shadow(0px_1px_3px_rgba(27,_37,_80,_0.14))]">
          I solve <FlipWords words={words} /> problems
        </h2>
      </div>
      <div className="flex flex-col mt-10 gap-4">
        <h3 className="text-lg dark:text-neutral-400 max-w-4xl mx-auto lg:text-3xl font-light font-libreFranklin">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <div>
            <ul className="flex text-gray-900 text-lg font-mono my-8">
